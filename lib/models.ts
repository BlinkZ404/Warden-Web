...
export const MODEL_PROVIDERS: ModelProvider[] = [
 ...
 placeholder: "sk-or-…",
 models: [
 { label: "Claude Opus 4.8 (Anthropic)", id: "anthropic/claude-opus-4.8" },
 { label: "Claude Opus 4.8 Fast (Anthropic)", id: "anthropic/claude-opus-4.8-fast" },
 { label: "GPT-5.5 (OpenAI)", id: "openai/gpt-5.5" },
 { label: "GPT-5.5 Pro (OpenAI)", id: "openai/gpt-5.5-pro" },
 { label: "Gemini 3.5 Flash (Google)", id: "google/gemini-3.5-flash" },
 { label: "DeepSeek V4 Pro (DeepSeek)", id: "deepseek/deepseek-v4-pro" },
 { label: "Grok 4.3 (xAI)", id: "x-ai/grok-4.3" },
 { label: "Qwen3.7 Max (Alibaba)", id: "qwen/qwen3.7-max" },
 { label: "Mistral Medium 3.5 (Mistral)", id: "mistralai/mistral-medium-3.5" },
 { label: "Kimi K2.6 (Moonshot)", id: "moonshotai/kimi-k2.6" },
 ],
 },
 {
 id: "claude",
